...
<div style="width: 100%; text-align: center">
  <p align="center" style="margin-bottom: 0">
    <img src="logo.png" style="margin: auto" width="360" />
    <br>
...
2. Click on the Tempermonkey icon and select "Dashboard"
3. Click on the "Utilities" tab
4. Find "Install from URL", paste the following link and click on "Install" button.
   ```
   https://github.com/shotwn/Ozges-Youtube-Studio-Translator/releases/latest/download/tempermonkey-userscript.js
   ```
### Manual Installation
...
### Configuration
1. Find GOOGLE_API_KEY config in the script and replace it with your own Google API key. You can get a Google API key by following the instructions [here](https://cloud.google.com/docs/authentication/api-keys).
   ```javascript 
   const GOOGLE_API_KEY = '<your-api-key>'; // Example: const GOOGLE_API_KEY = 'AIzaSyD-9VgTcZdYqZjrZsLuvL4Z9gqz5dKvHzE'
   ```
2. Save the script. You can do this by clicking on the "File" tab and selecting "Save".
3.  Done! You can now use the script. You can check if it is working by going to [Youtube Studio](https://studio.youtube.com/) and clicking on any video. You should see translation boxes under the video title and description.
